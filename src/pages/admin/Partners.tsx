        ...
        <div className="lg:col-span-2 space-y-4">
          {partners.length === 0 ? (
            ...
            partners.map((partner) => (
              <div key={partner.id} className="bg-white p-5 rounded-3xl shadow-sm border border-slate-100 flex gap-6 hover:border-purple-200 transition-all group">
                <div className={`w-16 h-16 rounded-2xl ${partner.color || 'bg-slate-900'} flex items-center justify-center text-white font-black text-xl flex-shrink-0 shadow-lg overflow-hidden`}>
                  {partner.logo ? (
                ...
                <div className="flex-1 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-sm text-slate-500 line-clamp-2 mt-1">{partner.description}</p>
                  </div>
